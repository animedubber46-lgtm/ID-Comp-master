...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @XIAO_BOTS" -metadata author="@DC4Premium" -metadata:s:s title="Subtitled By :- @XIAO_BOTS" -metadata:s:a title="By :- @XIAO_BOTS" -metadata:s:v title="By:- @DC4Premium" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
